...
class MaterialPaperColors {
  ...
  static Map<String, List<String>> RedT = {
  ...
  static List<Map<String, List<String>>> colorPaletteT = [RedT, PinkT, PurpleT, DeepPurpleT, IndigoT, BlueT, LightBlueT, CyanT, TealT, GreenT, LightGreenT, LimeT, YellowT, AmberT, OrangeT, DeepOrangeT, BrownT, GreyT, BlueGreyT];
  ...
  static List getRandomColorT(String level) {
    Random rng = new Random();
